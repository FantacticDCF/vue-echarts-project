	...
	<div>
		...
		<el-row>
			<el-col :span="12" class="line-box">
				...
				<div id="chartLineBox" style="width: 97%;height: calc(100vh - 400px)">
				</div>
			</el-col>
			<el-col :span="12" class="line-box">
				<p class="line-text">产品投诉数据</p>
				<div id="chartColumnBox" style="width: 97%;height: calc(100vh - 400px)"></div>
			</el-col>
		</el-row>
		<!--图表3和4-->
		<el-row>
			<el-col :span="12" class="line-box">
				...
				<div id="chartBreadBox" style="width: 97%;height: calc(100vh - 400px)"></div>
			</el-col>
			<el-col :span="12" class="line-box">
				<p class="line-text">客群投诉数据</p>
				<div id="chartRoundBox" style="width: 97%; height: calc(100vh - 400px)">
					<div class="chartRoundBoxContent">
						<div v-for="(item, index) in percentage" :key="index">
							<el-progress type="circle" class="circle2" :stroke-width="11" :width='115' :percentage="item.percentage">
							</el-progress>
